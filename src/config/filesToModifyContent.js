  ...
  return [
    ...
    },
    {
      ...
      paths: [
        ...
        `ios/${nS_NewName}.xcodeproj/xcshareddata/xcschemes/${nS_NewName}_Dev.xcscheme`,
        `ios/${nS_NewName}.xcodeproj/xcshareddata/xcschemes/${nS_NewName}_QA.xcscheme`,
        `ios/${nS_NewName}.xcodeproj/xcshareddata/xcschemes/${nS_NewName}_Stg.xcscheme`,
